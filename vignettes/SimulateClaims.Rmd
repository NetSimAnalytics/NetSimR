...
vignette: >
  %\VignetteIndexEntry{SimulateClaims}
...
The severity is then the sliced Log-Normal-Pareto distribution of the "SlicedDistribution" vignette, so its mean gives the expected total. With alpha 1.5 the variance is infinite, so the simulated mean converges slowly.
